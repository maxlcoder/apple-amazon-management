...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection gift_card_number
     ...
     * @property Grid\Column|Collection is_watching
     ...
     * @method Grid\Column|Collection gift_card_number(string $label = null)
     ...
     * @method Grid\Column|Collection is_watching(string $label = null)
     ...
     * @property Show\Field|Collection gift_card_number
     ...
     * @property Show\Field|Collection is_watching
     ...
     * @method Show\Field|Collection gift_card_number(string $label = null)
     ...
     * @method Show\Field|Collection is_watching(string $label = null)
